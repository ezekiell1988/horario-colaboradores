...
const TOUR_STEPS: DriveStep[] = [
  {
    popover: {
      title: "Vista de Hoy",
      description: "Esta pantalla muestra todos los colaboradores activos agrupados por turno para el día de hoy.",
    },
  },
  {
    element: "#hoy-cards",
    popover: {
      ...
      description: "Cada tarjeta representa un turno del día: Mañana (06–14), Tarde (14–22) y Noche (22–06). Se muestra quién está en turno y quién tiene el día libre.",
      side: "top",
    },
  },
  {
    element: "#hoy-libre",
    popover: {
      title: "Colaboradores libres",
      description: "Aquí aparecen los colaboradores que tienen día libre hoy según su patrón de rotación.",
      side: "top",
    },
  },
];
...
export default function HoyPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div id="hoy-cards" className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        {data.libre.length > 0 && (
          <div id="hoy-libre" className="rounded-xl border border-gray-200 bg-gray-50 overflow-hidden">
